...
function Homepage() {
  return (
    ...
    <h1 className="text-[6vw] text-left absolute pl-[15%] animate-fadeSlow">HI, I'M</h1>
      ...
      <p className="text-[2vw] w-[50vw] font-extralight absolute ml-[2vw] pl-[5%] pt-[15%] pb-[50px] animate-fadeSlowest text-stone-400">I'm a recent computer science graduate, committed to using technology as a force for positive change.</p>
      </div>
