    ...
    <Parallax speed={10}>
      <div className="flex items-center justify-center">
        <div className="grid sm:grid-cols-4 sm:grid-rows-2 place-content-center items-center">
          <h1 className="text-right sm:col-span-2 sm:row-span-1 sm:row-start-1	sm:col-start-1 text-[#722534] animate-fadeSlowest italic text-6xl	tracking-widest	">
            connect
          </h1>

          <a
            href="https://www.linkedin.com/in/r-petes/"
            className="text-center text-3xl font-thin	sm:col-span-2 sm:row-span-1 sm:row-start-1 sm:col-start-3 border-[#b8a5a0] hover:bg-[#eae5e1] rounded-full border-1 no-underline text-[#736d69] px-3 py-3 m-2 animate-fadeSlowest"
            target="_blank"
      ...
      <div className="flex items-center justify-center ">
        <img
          src={background}
          className="flex items-center justify-center h-[10vh] animate-fadeSlower mb-16"
        ></img>
      </div>
      </Parallax>
    </>
